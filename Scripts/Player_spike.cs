...
public class Player_spike : MonoBehaviour {
    ...
    Rigidbody2D rb;
    bool isDead = false;
    ScoreManager_spike Obj;
    MenuManager_spike menuManager;
    ...
    void Start () {
        ...
        menuManager = GameObject.Find("MenuManager").GetComponent<MenuManager_spike>();
        Obj = GameObject.Find("ScoreManager").GetComponent<ScoreManager_spike>();
